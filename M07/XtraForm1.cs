        ...
        private void bbiSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            else
            {
                ...
                if (chkPASS == true)
                {
                    ...
                    sbSQL.Append("  VALUES('" + MaterialType + "', N'" + glueCode.Text.Trim() + "', N'" + txeDescription.Text.Trim() + "', N'" + txeComposition.Text.Trim() + "', N'" + txeWeight.Text.Trim() + "', N'" + txeModelNo.Text.Trim() + "', N'" + txeModelName.Text.Trim() + "', '" + slueCategory.EditValue.ToString() + "', '" + slueStyle.EditValue.ToString() + "', '" + slueColor.EditValue.ToString() + "', '" + slueSize.EditValue.ToString() + "', '" + slueCustomer.EditValue.ToString() + "',  ");
                    sbSQL.Append("         N'" + txeBusinessUnit.Text.Trim() + "', N'" + cbeSeason.Text.Trim() + "', N'" + cbeClass.Text.Trim() + "', '" + glueBranch.EditValue.ToString() + "', N'" + txeCostSheet.Text.Trim() + "', '" + txeStdPrice.Text.Trim() + "', '" + slueFirstVendor.EditValue.ToString() + "', '" + PurchaseType + "', '" + txePurchaseLoss.Text.Trim() + "', '" + TaxBenefits + "', '" + Convert.ToDateTime(dteFirstReceiptDate.Text).ToString("yyyy-MM-dd") + "', '" + slueDefaultVendor.EditValue.ToString() + "', ");
                    sbSQL.Append("         '" + txeMinStock.Text.Trim() + "', '" + txeMaxStock.Text.Trim() + "', '" + txeStockSheifLife.Text.Trim() + "', '" + txeStdCost.Text.Trim() + "', '" + slueDefaultUnit.EditValue.ToString() + "', N'" + newFileName + "', N'" + txeLabTestNo.Text.Trim() + "', '" + Convert.ToDateTime(dteApprovedLabDate.Text).ToString("yyyy-MM-dd") + "', '" + txeQCInspection.Text.Trim() + "', ");
                    sbSQL.Append("         '" + strCREATE + "', GETDATE(), '" + strUPDATE + "', GETDATE()) ");
                    sbSQL.Append(" END ");
                    sbSQL.Append("ELSE ");
                    sbSQL.Append(" BEGIN ");
                    sbSQL.Append("  UPDATE Items SET ");
                    sbSQL.Append("      MaterialType = '" + MaterialType + "', Code = N'" + glueCode.Text.Trim() + "', Description = N'" + txeDescription.Text.Trim() + "', Composition = N'" + txeComposition.Text.Trim() + "', WeightOrMoreDetail = N'" + txeWeight.Text.Trim() + "',  ");
                    sbSQL.Append("      ModelNo = N'" + txeModelNo.Text.Trim() + "', ModelName = N'" + txeModelName.Text.Trim() + "', OIDCATEGORY = '" + slueCategory.EditValue.ToString() + "', OIDSTYLE = '" + slueStyle.EditValue.ToString() + "', OIDCOLOR = '" + slueColor.EditValue.ToString() + "', ");
                    sbSQL.Append("      OIDSIZE = '" + slueSize.EditValue.ToString() + "', OIDCUST = '" + slueCustomer.EditValue.ToString() + "', BusinessUnit = N'" + txeBusinessUnit.Text.Trim() + "', Season = N'" + cbeSeason.Text.Trim() + "', ClassType = N'" + cbeClass.Text.Trim() + "', ");
                    sbSQL.Append("      Branch = '" + glueBranch.EditValue.ToString() + "', CostSheetNo = N'" + txeCostSheet.Text.Trim() + "', StdPrice = '" + txeStdPrice.Text.Trim() + "', FirstVendor = '" + slueFirstVendor.EditValue.ToString() + "', PurchaseType = '" + PurchaseType + "', PurchaseLoss = '" + txePurchaseLoss.Text.Trim() + "', ");
                    ...
                    sbSQL.Append("      StockShelfLife = '" + txeStockSheifLife.Text.Trim() + "', StdCost = '" + txeStdCost.Text.Trim() + "', DefaultUnit = '" + slueDefaultUnit.EditValue.ToString() + "', PathFile = N'" + newFileName + "', LabTestNo = N'" + txeLabTestNo.Text.Trim() + "', ");
                        ...
                        if (dtVendor.Rows.Count > 0)
                        {
                            foreach (DataRow dr in dtVendor.Rows) // search whole table
                            {
                                if (dr["OIDVENDItem"].ToString() == "") //Insert
                                {
                                    ...
                                    if (dr["OIDVEND"].ToString() == slueFirstVendor.EditValue.ToString())
                                    {
                                        sbSQL.Append("N'" + txeMatDetails.Text.Trim() + "', N'" + txeMatCode.Text.Trim() + "', N'" + txeSMPLLotNo.Text.Trim() + "', '" + txePrice.Text.Trim() + "', N'" + txeCurrency.Text.Trim() + "',  ");
                                    }
                                    sbSQL.Append("'" + dr["LotSize"].ToString() + "', '" + dr["ProductionLead"].ToString() + "', '" + dr["DeliveryLead"].ToString() + "', '" + dr["ArrivalLead"].ToString() + "', '" + dr["POCancelPeriod"].ToString() + "', '" + dr["PurchaseLots1"].ToString() + "', '" + dr["PurchaseLots2"].ToString() + "', '" + dr["PurchaseLots3"].ToString() + "', N'" + dr["Remark"].ToString() + "')  ");
                                }
                                else //Update
                                {
                                    ...
                                    if (dr["OIDVEND"].ToString() == slueFirstVendor.EditValue.ToString())
                                    {
                                        sbSQL.Append("MatDetails = N'" + txeMatDetails.Text.Trim() + "', MatCode = N'" + txeMatCode.Text.Trim() + "', SMPLLotNo = N'" + txeSMPLLotNo.Text.Trim() + "', Price = '" + txePrice.Text.Trim() + "', Currency = N'" + txeCurrency.Text.Trim() + "',  ");
                                    }
                                    sbSQL.Append("LotSize = '" + dr["LotSize"].ToString() + "', ProductionLead = '" + dr["ProductionLead"].ToString() + "', DeliveryLead = '" + dr["DeliveryLead"].ToString() + "', ArrivalLead = '" + dr["ArrivalLead"].ToString() + "', POCancelPeriod = '" + dr["POCancelPeriod"].ToString() + "', PurchaseLots1 = '" + dr["PurchaseLots1"].ToString() + "', PurchaseLots2 = '" + dr["PurchaseLots2"].ToString() + "', PurchaseLots3 = '" + dr["PurchaseLots3"].ToString() + "', Remark = N'" + dr["Remark"].ToString() + "'  ");
